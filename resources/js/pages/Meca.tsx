...
import { 
  Car, MapPin, Phone, CreditCard, Star, User, Settings, Wrench, 
  LogOut, Navigation, Clock, CheckCircle, AlertTriangle, Menu, 
  X, BarChart3, Users, DollarSign, Sparkles, Volume2, Mic, 
  Send, Loader2, ChevronRight, ShieldCheck, Headphones, Camera,
  FileText, MessageSquare, Bell, Filter, Search, MoreVertical,
  ArrowUpRight, ArrowDownRight, LayoutDashboard, Briefcase, Home,
  Calendar, Battery, Fuel, Thermometer, AlertCircle, Zap,
  Heart, Shield, HelpCircle, Map, Package, Award, TrendingUp,
  Upload, Download, Eye, Edit, Trash2, Plus, Minus, RotateCcw,
  Video, Music, VolumeX, SkipBack, Play, SkipForward, Pause,
  PhoneCall, Voicemail, Coffee, Moon, Sun, Cloud, Wind, Droplets,
  ThermometerSun, Gauge, Cpu, ShieldAlert, Bike, Truck,
  Smartphone, Tablet, Watch, Headset, Printer, Router, Server,
  Database, Code, GitBranch, CloudRain, Umbrella, Snowflake,
  Waves, TreePine, Leaf, Sprout, Flame, Mountain, Compass,
  Globe, Flag, Building, Factory, Store, Hotel, School, Church,
  Hospital, Bank, Mail, Key, Lock, Unlock, EyeOff, QrCode,
  Radio, Tv, Gamepad2, Speaker, MicOff, VideoOff, Bluetooth,
  Wifi, Ethernet, Cctv, Satellite, Radar, Telescope, Microscope,
  Beaker, FlaskConical, Atom, Brain, HeartPulse, Stethoscope,
  Pill, Syringe, Scalpel, Bone, Eye as EyeIcon, Ear, BrainCircuit,
  Activity, Pulse, Thermometer as ThermometerIcon, Droplet,
  Wind as WindIcon, Cloud as CloudIcon, Sun as SunIcon,
  Moon as MoonIcon, Star as StarIcon, Planet, Rocket,
  Satellite as SatelliteIcon, Astronaut, UFO, Ghost, Skull,
  Sword, Shield as ShieldIcon, Armor, Helmet, Castle, Crown,
  ChessKnight, ChessQueen, ChessKing, ChessRook, ChessBishop,
  ChessPawn, Dice5, Dice6, Trophy, Medal, Target, Crosshair,
  Bullseye, Award as AwardIcon, BadgeCheck, BadgeAlert,
  Certificate, ScrollText, BookOpen, BookMarked, Library,
  Newspaper, FileCode, FileAudio, FileVideo, FileImage,
  FileArchive, FileSpreadsheet, FileSignature, FileSearch,
  FolderOpen, FolderPlus, HardDrive, Save, Share2, Link,
  ExternalLink, Copy, Scissors, Type, Bold, Italic, Underline,
  Strikethrough, AlignLeft, AlignCenter, AlignRight, AlignJustify,
  List, ListOrdered, ListChecks, Indent, Outdent, WrapText,
  Pilcrow, Sigma, Function, Infinity, Pi, Omega, Alpha, Beta,
  Gamma, Delta, Epsilon, Zeta, Eta, Theta, Iota, Kappa, Lambda,
  Mu, Nu, Xi, Omicron, Pi as PiIcon, Rho, Sigma as SigmaIcon,
  Tau, Upsilon, Phi, Chi, Psi, Omega as OmegaIcon
} from 'lucide-react';
