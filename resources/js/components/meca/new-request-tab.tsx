...
import {
  Navigation, Battery, Cpu, Fuel, Truck, HelpCircle,
  Phone, PhoneCall
} from 'lucide-react';
...
export const NewRequestTab: React.FC<NewRequestTabProps> = ({ onCreateRequest }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center max-w-4xl mx-auto">
      ...
      <div className="w-full space-y-8">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            { type: 'tire', label: 'Pneu crevé', icon: Navigation, color: 'amber' },
